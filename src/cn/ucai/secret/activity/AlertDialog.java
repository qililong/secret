...
import cn.ucai.secret.task.DownloadImageTask;
...
public class AlertDialog extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.secret.R.layout.alert_dialog);
		mTextView = (TextView) findViewById(cn.ucai.secret.R.id.title);
		mButton = (Button) findViewById(cn.ucai.secret.R.id.btn_cancel);
		imageView = (ImageView) findViewById(cn.ucai.secret.R.id.image);
		editText = (EditText) findViewById(cn.ucai.secret.R.id.edit);
		//提示内容
		...
		if(msg != null)
		    ((TextView)findViewById(cn.ucai.secret.R.id.alert_message)).setText(msg);
		if(title != null)
		...
		if(path != null){
		    ...
		    ((TextView)findViewById(cn.ucai.secret.R.id.alert_message)).setVisibility(View.GONE);
