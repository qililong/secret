...
import cn.ucai.secret.video.util.Utils;
import cn.ucai.secret.widget.RecyclingImageView;
...
public class ImageGridFragment extends Fragment implements OnItemClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageThumbSize = getResources().getDimensionPixelSize(
				cn.ucai.secret.R.dimen.image_thumbnail_size);
		mImageThumbSpacing = getResources().getDimensionPixelSize(
				cn.ucai.secret.R.dimen.image_thumbnail_spacing);
		...
		mImageResizer.setLoadingImage(cn.ucai.secret.R.drawable.empty_photo);
	...
	public View onCreateView(LayoutInflater inflater,
		...
		final View v = inflater.inflate(cn.ucai.secret.R.layout.image_grid_fragment,
				container, false);
		final GridView mGridView = (GridView) v.findViewById(cn.ucai.secret.R.id.gridView);
	...
	public void onItemClick(AdapterView<?> parent, View v, final int position, long id) {
		...
		if(position==0)
		{
			...
			if (vEntty.size > 1024 * 1024 * 10) {
				String st = getResources().getString(cn.ucai.secret.R.string.temporary_does_not);
	...
	private class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup container) {
			 ...
			 if(convertView==null)
			 {
				 ...
				 convertView=LayoutInflater.from(mContext).inflate(cn.ucai.secret.R.layout.choose_griditem, container,false);
				 holder.imageView=(RecyclingImageView) convertView.findViewById(cn.ucai.secret.R.id.imageView);
				 holder.icon=(ImageView) convertView.findViewById(cn.ucai.secret.R.id.video_icon);
				 holder.tvDur=(TextView)convertView.findViewById(cn.ucai.secret.R.id.chatting_length_iv);
				 holder.tvSize=(TextView)convertView.findViewById(cn.ucai.secret.R.id.chatting_size_iv);
			...
			String st1 = getResources().getString(cn.ucai.secret.R.string.Video_footage);
			if(position==0)
			{
				holder.icon.setVisibility(View.GONE);
				holder.tvDur.setVisibility(View.GONE);
				holder.tvSize.setText(st1);
				holder.imageView.setImageResource(cn.ucai.secret.R.drawable.actionbar_camera_icon);
			}else{
				...
				holder.imageView.setImageResource(cn.ucai.secret.R.drawable.empty_photo);
