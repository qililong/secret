...
import cn.ucai.secret.adapter.GroupAdapter;
...
public class GroupsActivity extends BaseActivity {
					...
					if (success) {
						...
						if (!GroupsActivity.this.isFinishing()) {
							String s1 = getResources()
									.getString(
											cn.ucai.secret.R.string.Failed_to_get_group_chat_information);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.secret.R.layout.fragment_groups);

		instance = this;
		inputMethodManager = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
		grouplist = EMGroupManager.getInstance().getAllGroups();
		groupListView = (ListView) findViewById(cn.ucai.secret.R.id.list);
		...
		progressBar = (View)findViewById(cn.ucai.secret.R.id.progress_bar);
