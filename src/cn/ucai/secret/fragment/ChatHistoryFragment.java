...
import cn.ucai.secret.adapter.ChatHistoryAdapter;
...
public class ChatHistoryFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(cn.ucai.secret.R.layout.fragment_conversation_history, container, false);
	}
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		errorText = (TextView) errorItem.findViewById(cn.ucai.secret.R.id.tv_connect_errormsg);
		// contact list
		...
		final String st = getResources().getString(cn.ucai.secret.R.string.Cant_chat_with_yourself);
	...
	public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
		...
		getActivity().getMenuInflater().inflate(cn.ucai.secret.R.menu.delete_message, menu);
		// }
	}

	@Override
	public boolean onContextItemSelected(MenuItem item) {
		if (item.getItemId() == cn.ucai.secret.R.id.delete_message) {
	 ...
	 */
	public void refresh() {
		adapter = new ChatHistoryAdapter(getActivity(), cn.ucai.secret.R.layout.row_chat_history, loadUsersWithRecentChat());
		listView.setAdapter(adapter);
		adapter.notifyDataSetChanged();
	}
