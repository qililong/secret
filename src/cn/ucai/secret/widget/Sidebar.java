...
public class Sidebar extends View{
	...
	private void init(){
	    String st = context.getString(cn.ucai.secret.R.string.search_new);
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_DOWN:{
			if(header == null){
				header = (TextView) ((View)getParent()).findViewById(cn.ucai.secret.R.id.floating_header);
			}
			setHeaderTextAndscroll(event);
			header.setVisibility(View.VISIBLE);
			setBackgroundResource(cn.ucai.secret.R.drawable.sidebar_background_pressed);
			return true;
		}
